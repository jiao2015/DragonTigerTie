...
#if CCX3
	PomeloDisconnectedCallback mDisconnectCB;
#else
...
_PomeloRequestResult* CCPomeloImpl::popReqResult(bool lock)
{
...
_PomeloNotifyResult* CCPomeloImpl::popNtfResult(bool lock)
{
...
_PomeloEvent* CCPomeloImpl::popEvent(bool lock)
{
...
void CCPomeloImpl::requestCallback(pc_request_t *request, int dstatus, json_t *docs)
{
...
void CCPomeloImpl::notifyCallback(pc_notify_t *ntf, int dstatus)
{
	if (gPomelo->status() == EPomeloStopping)
	{
...
int CCPomeloImpl::setDisconnectedCallback(const PomeloDisconnectedCallback& callback)
{
...
int CCPomeloWrapper::setDisconnectedCallback(const PomeloDisconnectedCallback& callback)
{
